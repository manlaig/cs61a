...
class VendingMachine:
    ...
    def vend(self):
        ...
        s = 'Here is your ' + self.name + (' and $' + str(self.amount - self.price) + ' change.' if self.amount - self.price != 0 else '.')
        self.amount = 0
        self.stock -= 1
        return s
    ...
    def deposit(self, val):
        if self.stock <= 0:
            return 'Machine is out of stock. Here is your $' + str(val) + '.'
        self.amount += val
